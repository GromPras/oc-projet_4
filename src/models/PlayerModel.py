...
class PlayerModel:
    ...
    def __init__(self, first_name: str, last_name: str, birth_date: str, national_chess_id: str, score: Optional[int]) -> None:
...
{self.fullname()} - né(e) le : {self.birth_date}"
    ...
    def save(self) -> PlayerModel:
        ...
        try:
            ...
            raise SaveError(message="[ERREUR]: le fichier n'a pas pu être sauvegardé")
    ...
    def get_all(cls):
        ...
        try:
            ...
            raise LoadError(message="[ERREUR]: le fichier joueurs n'a pas pu être chargé")
    ...
    def load_by_id(cls, id: str) -> PlayerModel | None:
        ...
        if players and national_chess_id:
            player_data = [
                player for player in players if player.national_chess_id == national_chess_id
            ]
